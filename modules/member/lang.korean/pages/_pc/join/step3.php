...
<div id="pages_join">
	...
	<td>
		<div id="addrbox">
		<div>
		<input type="text" name="zip_1" id="zip1" value="" maxlength="5" size="5" readonly="readonly" class="input" /> 
	...
	<td colspan="3">
		<div>
		<input type="text" name="comp_zip_1" id="comp_zip1" value="" maxlength="5" size="5" readonly="readonly" class="input" />
